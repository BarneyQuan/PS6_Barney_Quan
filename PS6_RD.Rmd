...
stargazer(reg4, reg5, reg6, reg7, reg8, reg9, type = "text", title = c("PANES Program Eligibility, Participation, and Political Support for the Government"), covariate.labels = c("Government support, 2007 (during program)"), dep.var.labels = c("Indicator (Standard Errors)"))
